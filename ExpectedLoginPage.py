...
#===============Variables=====================
        ...
        bg_lbl.pack()
        title=Label(self.root,text="EMPLOYEE LOGIN",font=('Constantia',35,'bold','italic'),fg="white",bd=10,relief=GROOVE,bg='Cadet blue')
        ...
        Btn_Frame.place(x=550,y=570)

        userlbl=Label(Login_Frame,image=self.user_icon,compound=CENTER,bg='white')
        userlbl.grid(row=0,columnspan=2)

        lbluser=Label(Login_Frame,text="Username*",image=self.username_icon,compound=LEFT,font=('times new roman',12,'bold'))
        lbluser.grid(row=1,padx=10,pady=10)
        txtuser=Entry(Login_Frame,bd=5,textvariable=username,relief=GROOVE,font=('times new roman',12,'bold'))
        txtuser.grid(row=1,column=1,padx=10)

        lblpass=Label(Login_Frame,text="Password*",image=self.password_icon,compound=LEFT,font=('times new roman',12,'bold'))
        lblpass.grid(row=2,padx=10,pady=10)
        txtpass=Entry(Login_Frame,bd=5,relief=GROOVE,textvariable=password,show='*',font=('times new roman',12,'bold'))
        txtpass.grid(row=2,column=1,padx=10)

        btn_log=Button(Btn_Frame,text="LOGIN",font=('times new roman',12,'bold'),fg="black",command=login)
        btn_log.grid(row=0,column=0,padx=5)

        btn_register=Button(Btn_Frame,text='REGISTER',font=('times new roman',12,'bold'),command=register)
        btn_register.grid(row=0,column=1,padx=5)

        btn_reset=Button(Btn_Frame,text='RESET',font=('times new roman',12,'bold'),command=reset)
        btn_reset.grid(row=0,column=2,padx=5)

        btn_exit=Button(Btn_Frame,text='EXIT',font=('times new roman',12,'bold'),command=iExit)
...
#def login_success():
    class Employee():
        def __init__(self,roo):
            ...
            MainFrame = Frame(self.root, bd = 10,width =1350, height = 700,bg='gainsboro',relief= GROOVE)
            MainFrame.grid()

            TopFrame1 = Frame(MainFrame, bd = 7,width =1340, height = 50,bg='gainsboro',relief=GROOVE)
            TopFrame1.grid(row = 2, column = 0)

            TopFrame2 = Frame(MainFrame, bd = 7,width =1340, height = 100,bg='gainsboro',relief=GROOVE)
            TopFrame2.grid(row = 1,column = 0)

            TopFrame3 = Frame(MainFrame, bd = 7,width =1340, height = 500,bg='gainsboro',relief=GROOVE)
            TopFrame3.grid(row = 0,column = 0)

            LeftFrame = Frame(TopFrame3,bd=5, width = 1340,height=400,padx=2,bg='gainsboro',relief=GROOVE)
            LeftFrame.pack(side=LEFT)
            LeftFrame1 = Frame(LeftFrame,bd=5, width = 600,height=180,padx=4,pady=4,bg='gainsboro',relief=GROOVE)
            LeftFrame1.pack(side=TOP)

            LeftFrame2 = Frame(LeftFrame,bd=5, width = 600,height=180,padx=4,pady=4,bg='gainsboro',relief=GROOVE)
            LeftFrame2.pack(side=TOP)
            LeftFrame2Left = Frame(LeftFrame,bd=5, width = 300,height=170,padx=2,bg='gainsboro',relief=GROOVE)
            LeftFrame2Left.pack(side=LEFT)
            LeftFrame2Right = Frame(LeftFrame2,bd=5, width = 300,height=170,padx=2,bg='gainsboro',relief=GROOVE)
            LeftFrame2Right.pack(side=RIGHT)

            RightFrame1 = Frame(TopFrame3,bd=5, width = 320,height=400,padx=2,bg='gainsboro',relief=GROOVE)
            RightFrame1.pack(side=RIGHT)
            RightFrame1a = Frame(RightFrame1,bd=5, width = 310,height=300,padx=2,bg='gainsboro',relief=GROOVE)
            RightFrame1a.pack(side=TOP)
            RightFrame2 = Frame(TopFrame3,bd=5, width = 300,height=400,padx=2,bg='gainsboro',relief=GROOVE)
            RightFrame2.pack(side=RIGHT)
            RightFrame2a = Frame(RightFrame2,bd=5, width = 280,height=50,padx=2,bg='gainsboro',relief=GROOVE)
            RightFrame2a.pack(side=TOP)
            RightFrame2b = Frame(RightFrame2,bd=5, width = 280,height=180,padx=2,bg='gainsboro',relief=GROOVE)
            RightFrame2b.pack(side=TOP)
            RightFrame2c = Frame(RightFrame2,bd=5, width = 280,height=100,padx=2,bg='gainsboro',relief=GROOVE)
            RightFrame2c.pack(side=TOP)
            RightFrame2d = Frame(RightFrame2,bd=5, width = 280,height=50,padx=2,bg='gainsboro',relief=GROOVE)
    ...
    #=============================================================================================================
            self.lbLabel = Label(TopFrame2, font=('arial',10,'bold'),padx=6,pady=2,bg='gainsboro',
    ...
    #=================================================Widget=============================================================
            self.lblReference= Label(LeftFrame1,font=('arial',12,'bold'),text="Referrence",bd=7,bg='gainsboro',anchor='w')
            ...
            self.lblAddress= Label(LeftFrame1,font=('arial',12,'bold'),text="Address",bd=7,bg='gainsboro')
            ...
            self.lblGender= Label(LeftFrame1,font=('arial',12,'bold'),text="Gender",bd=7,bg='gainsboro')
    ...
    #====================================================================================================================
            self.lblCityWeighting= Label(LeftFrame2Left,font=('arial',12,'bold'),text="City Weighting",bd=7,bg="gainsboro",anchor='e')
            ...
            self.lblBasicSalary= Label(LeftFrame2Left,font=('arial',12,'bold'),text="Basic Salary",bd=7,bg="gainsboro",anchor='w',justify='left')
            ...
            self.lblOverTime= Label(LeftFrame2Left,font=('arial',12,'bold'),text="Over Time",bd=7,bg="gainsboro",anchor='w',justify='left')
            ...
            self.lblOtherPaymentDue= Label(LeftFrame2Left,font=('arial',12,'bold'),text="Other Payment Due",bd=7,bg="gainsboro",anchor='w',justify='left')
    ...
    #=================================================================================================================================================
            ...
            self.lblTaxPeriod = Label(RightFrame2a,font=('arial',12,'bold'),text="Tax Period",bd=7,bg="gainsboro",anchor='w',justify='left')
            ...
            self.lblNINumber = Label(RightFrame2c,font=('arial',12,'bold'),text="NI Number",bd=7,bg="gainsboro",anchor='w',justify='left')
            ...
            self.lblPensionablePay = Label(RightFrame2c,font=('arial',12,'bold'),text="Pensionable Pay",bd=7,bg="gainsboro",anchor='w',justify='left')
    ...
    #=====================================================================Buttons for the topframe1====================================================================================
            self.btnAddNewTotal=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,bg='gainsboro',
                                width=8,text="AddNew/Total",command=MonthlySalary).grid(row=0,column=1,padx=1)
            self.btnPrint=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,bg='gainsboro',
                                width=8,text="Print",command=iPrint).grid(row=0,column=2,padx=1)
            self.btnDisplay=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,bg='gainsboro',
                                width=8,text="Display",command=DisplayData).grid(row=0,column=3,padx=1)
            self.btnUpdate=Button(TopFrame1,pady=1,bd=4,fg="black",font=('arial',16,'bold'),padx=24,bg='gainsboro',
